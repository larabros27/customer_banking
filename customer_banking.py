...
def main():
    ...
    savings_maturity = int(input("Enter the number of months you wish to save into savings: "))
    ...
    cd_maturity = int(input("Enter the number of months you wish to save into cd: "))
